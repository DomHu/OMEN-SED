...
%     xlabel('Longitude')
%     ylabel('Latitude')
%     print(fig_OM_ox_total_mmol,'-depsc2', ['./plots/' exp_name '_OM_oxidation_Total_' str_date '_mmmolm2yr_until200.eps']);
%     
    fig_OM_ox_total= figure; %('Renderer', 'painters', 'Position', [10 10 900 600]);
    %set(gca,'FontSize',30)
    pcolor(long, lat, Cox_total/1000*100^(-2)*10^6);
    hold on;
    % set(gca,'Color',lightGrey2)
    % set(gcf,'inverthardcopy','off');
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_total,'-depsc2', ['./plots/' exp_name '_OM_oxidation_Total_' str_date '.eps']);
        
    
    % rates for diff TEA in mumol cm-2 yr-1
	fig_OM_ox_aerobic= figure;
    %set(gca,'FontSize',30)
    pcolor(long, lat, (Cox_aerobic/1000)*100^(-2)*10^6);
    hold on;
    % set(gca,'Color',lightGrey2)
    % set(gcf,'inverthardcopy','off');
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_aerobic,'-depsc2', ['./plots/' exp_name '_OM_oxidation_aerobic_' str_date '.eps']);
      
        
	fig_OM_ox_denit= figure;
    %set(gca,'FontSize',30)
    pcolor(long, lat, (Cox_denitr/1000)*100^(-2)*10^6);
    hold on;
    % set(gca,'Color',lightGrey2)
    % set(gcf,'inverthardcopy','off');
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_denit,'-depsc2', ['./plots/' exp_name '_OM_oxidation_denit_' str_date '.eps']);
        
	fig_OM_ox_Fe_red= figure;
    %set(gca,'FontSize',30)
    pcolor(long, lat, (Cox_FeIII/1000)*100^(-2)*10^6);
    hold on;
    % set(gca,'Color',lightGrey2)
    % set(gcf,'inverthardcopy','off');
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_Fe_red,'-depsc2', ['./plots/' exp_name '_OM_oxidation_Fe_red_' str_date '.eps']);
        
	fig_OM_ox_sulfate_red= figure;
    %set(gca,'FontSize',30)
    pcolor(long, lat, (Cox_sulfate/1000)*100^(-2)*10^6);
    hold on;
    % set(gca,'Color',lightGrey2)
    % set(gcf,'inverthardcopy','off');
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_sulfate_red,'-depsc2', ['./plots/' exp_name '_OM_oxidation_Sulfate_red_' str_date '.eps']);
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_aerobic_frac,'-depsc2', ['./plots/' exp_name '_OM_oxidation_aerobic_frac_' str_date '.eps']);
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_denit_frac,'-depsc2', ['./plots/' exp_name '_OM_oxidation_denit_frac_' str_date '.eps']);
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_Fe_red_frac,'-depsc2', ['./plots/' exp_name '_OM_oxidation_Fe_red_frac_' str_date '.eps']);
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_OM_ox_sulfate_red_frac,'-depsc2', ['./plots/' exp_name '_OM_oxidation_Sulfate_red_frac_' str_date '.eps']);
...
if(plot_SWI_fluxes)
    ...
    %set(gca,'FontSize',30)
    pcolor(long, lat, Flux_Fe2_logmumolcm);    
    hold on;
    % set(gca,'Color',lightGrey2)
    % set(gcf,'inverthardcopy','off');
    ...
    xlabel('Longitude')
    ylabel('Latitude')
    print(fig_Fe2_efflux_myunits,'-depsc2', ['./plots/SWI_flux_Fe2_' exp_name '_' str_date '.eps']);
...
%    ylabel('SFD  (km)');
    ...
    print(fig_SWI_fluxes, '-depsc2', ['./plots/' exp_name '_hypsometry_SWIfluxes_' str_date '.eps']);
    ...
    plot(Hypsometry_zNO3,-hypsometry_meanDepth/1000,'ks--','MarkerFaceColor','k','MarkerSize',12);
...
%    xlim([0.0 100])
    ...
    lgd.FontSize = 20;
    print(fig_penetration_depths, '-depsc2', ['./plots/' exp_name '_hypsometry_PenetrationDepths_' str_date '.eps']);
