...
best_estimate = true;
uncertainty_ANA = false;
uncertainty_ANA_old = false;
...
% TODO: loop to calc a-values for uncertainty propagation
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%              CALCULATE a-VALUES FOR BEST TOC & POR
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    % orginal toc from MArkus without back calculation
    if best_estimate % used before, e.g., 240810
...
if uncertainty_ANA
    ...
    for k=1:SA_exps         % k = 3, problems at x=213, y=1296  -- zbio_Matching_fails in while-loop
    ...
    if uncertainty_ANA_old      % extreme boundary conditions
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%% use Burwicz and Middelburg SAR
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
