...
%           w = 10.0.^(-0.87478367-0.00043512*wdepth)*3.3;
            % sedimentation rate, cm/yr (after Burwicz et al. (2011)) PP
              w = 0.117./(1+(wdepth/200).^3)+0.006./(1+(wdepth/4000).^10);
            if w<=0;error(['w(' num2str(w) ')<=0;SFD=' num2str(wdepth)]);end
        end
